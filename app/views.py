...
from .utils import from_contact, from_book
...
def contact(request):
    if request.method == 'POST':
        ...
        mail = from_contact(subject, message_body, user_email, user_name, phone  )
...
def book(request):
    if request.method == 'POST':
        ...
        date = data.get('date')
        message_body = data.get('message')
        mail = from_book(subject, message_body, user_email, user_name, date  )
